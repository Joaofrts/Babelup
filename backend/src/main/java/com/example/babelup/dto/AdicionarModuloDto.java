...
public class AdicionarModuloDto {
    ...
    public AdicionarModuloDto() {}

    public AdicionarModuloDto( String titulo, String descricao, List<VideoAula> videoAulas, List<MaterialApoio> materialApoios, UUID nivelId, Integer ordem) {
        this.titulo = titulo;
